...
public class EventListener {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event)
    {
        ...
        {
            ZHFState = !ZHFState;
            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Toggled Cornering to "+(ZHFState ? "on" : "off")));
        }

        if (Keybinds.toggleBlockAlarm.isPressed())
        {
            blockAlarm = !blockAlarm;
            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Toggled Block Alarm to "+(blockAlarm ? "on" : "off")));
        }
    ...
    public void onRenderLiving(RenderLivingEvent.Pre event) {
        if(ZHFState && event.entity != null && event.entity instanceof EntityPlayer) {
